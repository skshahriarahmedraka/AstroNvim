...
nnoremap <silent> <M-x> <Cmd>BufferClose
...
set tabline=%8@barbar#events#main_click_handler@%#BufferInactiveSign#▎%#BufferInactive#\ %#BufferInactive#󰟓\ %8@barbar#events#main_click_handler@%#BufferInactive#main.go%#BufferInactive#\ %8@barbar#events#close_click_handler@%#BufferInactiveBtn#×\ %8@barbar#events#main_click_handler@%#BufferInactiveSignRight#%9@barbar#events#main_click_handler@%#BufferInactiveSign#▎%#BufferInactive#\ %#BufferInactive#\ %9@barbar#events#main_click_handler@%#BufferInactive#docker-compose.yml%#BufferInactive#\ %9@barbar#events#close_click_handler@%#BufferInactiveBtn#×\ %9@barbar#events#main_click_handler@%#BufferInactiveSignRight#%10@barbar#events#main_click_handler@%#BufferCurrentSign#▎%#BufferCurrent#\ %#BufferCurrentIndex#3\ %#MiniIconsBlueCurrent#󰡨\ %10@barbar#events#main_click_handler@%#BufferCurrent#Dockerfile%#BufferCurrent#\ %#BufferCurrentBtn#%10@barbar#events#main_click_handler@%#BufferCurrentSignRight#%#BufferInactiveSign#▎%#BufferTabpageFill#\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ %0@barbar#events#main_click_handler@%#BufferTabpageFill#
set tabstop=2
set termguicolors
set timeoutlen=500
set title
...
setlocal statusline=%#lualine_a_normal#\ N\ %#lualine_b_normal#\ \ LZ-821\ %<%#lualine_c_normal#\ Dockerfile\ %#lualine_c_diagnostics_warn_normal#\ \ 2\ %#lualine_c_diagnostics_info_normal#\ 4\ %#lualine_c_normal#%=%#lualine_x_4_normal#\ \ GitHub\ Copilot,\ dockerls\ %#lualine_c_normal#%#lualine_x_5_normal#\ \ TS\ %#lualine_c_normal#%#lualine_c_normal#\ utf-8\ %#lualine_c_normal#\ \ %#lualine_x_filetype_MiniIconsBlue_normal#\ 󰡨\ %#lualine_c_normal#dockerfile\ %#lualine_b_normal#\ Top\ %#lualine_a_normal#\ \ \ 1:34\ 
